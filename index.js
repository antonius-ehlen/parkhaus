...
const ausparkenAutos_1 = __importDefault(require("./ausparkenAutos"));
const myprompt = require('prompt-sync')({ sigint: true });
const parkeAutos = require("./parkeAutos");
// Variables
let parkhaus;
// funktions
function makeParkhaus() {
    let anzEtagen = 2;
    let anzPlaetze = 20;
    ...
    for (let et = 0; et < parkhaus.anzEtagen; et++) {
        ...
        let etage = { anzPlaetze: parkhaus.plaetzeProEtage, plaetze: [], };
        // etage hinzufügen
...
statusParkhaus(parkhaus);
(0, ausparkenAutos_1.default)(parkhaus, 3);
statusParkhaus(parkhaus);
parkeAutos(parkhaus, 9);
statusParkhaus(parkhaus);
(0, ausparkenAutos_1.default)(parkhaus, 22);
statusParkhaus(parkhaus);
